...
public struct EmailFactory{
    ...
    public func createEmail(to recipient: JobApplication) -> Email{
        ...
        case .interview:
            ...
            messageBody = "Can you come in for an interview in 30 minutes?"
        case .hired:
            subject = "We Want to Hire You"
            messageBody = "Congratulations, \(recipient.name)! " + "We liked your code, and you smelled nice. " +
...
//Example
var jackson = JobApplication(name: "Jackson Smith", email: "jackson.smith@example.com", status: .new)
let emailFactory = EmailFactory(senderEmail: "ray@ray.com")
